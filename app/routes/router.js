...
router.get("/comprar-pacote", ComprarPacoteControllerRead.getPage);

router.get("/fale-conosco", FaleConoscoControllerRead.getPage);

// * Cadastro
router.get("/cadastro", CadastroControllerRead.getPage);

router.post("/cadastro", AuthenticationMiddleware.encryptPassword, CadastroControllerCreate.createUser)
...
router.get("/adicionar-conta", AuthenticationMiddleware.validateJWT, AdicionarContaControllerRead.getPage)

router.get("/metas", AuthenticationMiddleware.validateJWT, MetasControllerRead.getPage);

router.get("/tags", AuthenticationMiddleware.validateJWT, TagsControllerRead.getPage);

router.get("/questionario", AuthenticationMiddleware.validateJWT, QuestionarioControllerRead.getPage);

// * Conta conjunta
router.get("/conta-conjunta", AuthenticationMiddleware.validateJWT, ContaConjuntaControllerRead.getPage);
